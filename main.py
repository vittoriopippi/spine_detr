...
def get_args_parser():
    ...
    parser.add_argument('--2d_spine_ann', type=str)
    parser.add_argument('--2d_spine_images', type=str)
...
def main(args):
    ...
    if args.eval:
        test_stats, coco_evaluator = evaluate(model, criterion, postprocessors,
                                              data_loader_val, base_ds, device, args.output_dir, epoch=0, writer=writer, args=args)
        if args.output_dir:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats, coco_evaluator = evaluate(
            model, criterion, postprocessors, data_loader_val, base_ds, device, args.output_dir, epoch=epoch, writer=writer, args=args
        )
